var app = (function () {
      ...
      (n = new Ee({})),
      {
        c() {
          Q(n.$$.fragment),
            (r = x()),
            (s = w("p")),
            (s.textContent = "SEVENTEEN right here...");
        },
        m(e, t) {
  ...
  var wt = yt(function (e, t) {
      ...
      (n = function () {
        ...
        return function e(t) {
          t.data.src = Array.from(new Set(t.data.src));
          (this.options = t),
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a>, and <a href="https://heardle-kpop.glitch.me/" title="Heardle">K-Pop Heardle</a> but for SEVENTEEN songs.</p> \n\n<p class="mb-3">Each SEVENTEEN Heardle is randomly chosen from SEVENTEEN\'s discography. Includes solo songs and OSTs!</p> \n\n\n\n <p>Originally cloned by @oshuawotts on twitter.<br /><br />&#127800Debugged by @stellarstrike on 7/26/2022&#127800<br /><br />Need help? DM me on <a href="https://twitter.com/stellarstrike">Twitter</a> <a href="https://www.instagram.com/stellarstrike/">Instagram</a> <a href="https://github.com/Stellarstrike84">GitHub</a><br /><br /></p> \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">Soundcloud</a>,\n    <a href="https://svelte.dev">Svelte</a>,\n    <a href="https://tailwindcss.com">Tailwind</a>,\n    <a href="https://fonts.google.com/noto/specimen/Noto+Serif+Display">Noto Serif Display</a>, <a href="https://fonts.google.com/noto/specimen/Noto+Sans">Noto Sans</a>,\n    <a href="https://iconsvg.xyz">IconSVG</a>, <a href="https://momentjs.com">momentjs</a>,\n    <a href="https://tarekraafat.github.io/autoComplete.js/#/">autocomplete.js</a>, and powered by <a href="https://glitch.com/">Glitch</a>. <a href="https://omakase.studio" title="Studio Omakase">Served omakase / お任せ</a>. SEVENTEEN version made by <a href ="https://twitter.com/oshuawotts">Mer</a>.</p> '),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
  ...
  function jt(e, t, n) {
    ...
    return (
      P(async function () {
        (async function () {
          const e = await fetch(
            "https://svt-heardle.glitch.me/supporters.json"
          );
          return await e.json();
        })().then((e) => {
          n(0, (r = e.supporters));
    ...
    return (
      ...
      (u = new Bt({})),
      {
        c() {
          (n = w("p")),
            (n.innerHTML =
              "Have questions/run into bugs? DM me @Stellarstrike on Twitter."),
            (r = x()),
            (s = w("p")),
            (s.innerHTML =
              '<p class="mb-3">If you\'ve enjoyed any of the heardle derivatives, consider donating to the <a href="https://ko-fi.com/heardle">real Heardle devs</a> and the <a href="https://ko-fi.com/heardlekpop">K-pop Heardle devs</a>'),
            (i = x()),
            (o = w("div")),
            Q(a.$$.fragment),
            (l = x()),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's SEVENTEEN Heardle in the first ")),
          (n = _(s)),
          (r = _(" seconds"));
      },
      m(e, s) {
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("you didn't get today's SEVENTEEN Heardle :(");
      },
      m(e, t) {
        g(e, n, t);
      },
      ...
      [
        ...
        () => {
          ...
          let o =
            ...
            "\n\n" +
            t +
            "\n\n@pledis_17 #SEVENTEEN #SVT_WORLD #SECTOR17\n\n http://svtsaythename-heardle.glitch.me/";
          if (
            !navigator.share ||
  ...
  const Cn = ue([
      ...
      "Domino - SEVENTEEN",
      "Ash - SEVENTEEN",
      "Warrior (OST) - JOSHUA, JUN, THE8, MINGYU, VERNON",
      "Hai Cheng - THE8",
      "Crow - Wen Junhui",
    ...
    On = {
      subscribe: ue(
        [
          ...
          {
            url: "https://soundcloud.com/wonwoosvt/hoshi-power",
            answer: "호랑이 Power - Hoshi",
          },
          {
          ...
          {
            url: "https://soundcloud.com/seventeen-scmusic/2-minus-1-bonus-track",
            answer: "2MINUS1 - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/user-86846981/my-i",
            answer: "My I - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/v-di-n-541534797/seventeen-a-teen-ost",
            answer: "A-TEEN - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/seventeen-scmusic/darl-ing",
            answer: "Darl+ing - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/sophia_10_16_hime/seventeen-say-yes",
            answer: "Say Yes - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/1717p/pinwheelvocal17",
            answer: "Pinwheel - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/yoru-zen/seventeen-fallingforu",
            answer: "Falling for U - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/wonwoosvt/vernon-bands-boy",
            answer: "BANDS BOY - Vernon",
          },
          {
          ...
          {
            url: "https://soundcloud.com/moonlitpearl/seventeen-shhh",
            answer: "Shhh - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/pledis_seventeen/seventeen-mixtape-vol14-concert-ver",
            answer: "Un Haeng Il Chi - HHU",
          },
          {
          ...
          {
            url: "https://soundcloud.com/kookies-and-anime/seventeen-thanks-audio-h-o-n-e",
            answer: "Thanks - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/ur7zhym2ztpu/seventeen-run-to-you-special",
            answer: "Run to You - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/farahnuraffrina/habit",
            answer: "Habit - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/l2share83/seventeen-lie-again",
            answer: "Lie Again - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/l2shareost41/dk-seventeen-go-twenty-five-twenty-one-ost-part-5",
            answer: "Go! - DK",
          },
          {
            url: "https://soundcloud.com/ur7zhym2ztpu/seventeen-thinkin-about-you",
            answer: "Thinkin' about You - SEVENTEEN",
          },
          {
          ...
          {
            url: "https://soundcloud.com/seventeen-scmusic/hot",
            answer: "HOT - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/seventeen-scmusic/don-quixote",
            answer: "Don Quixote - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/seventeen-scmusic/2-minus-1-bonus-track",
            answer: "2MINUS1 - SEVENTEEN",
          ...
          {
            url: "https://soundcloud.com/seventeen-scmusic/domino",
            answer: "Domino - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/v-di-n-541534797/seventeen-a-teen-ost",
            answer: "A-TEEN - SEVENTEEN",
          ...
          {
            url: "https://soundcloud.com/user-785348103/seventeen-warrior-falling-into",
            answer: "Warrior (OST) - JOSHUA, JUN, THE8, MINGYU, VERNON",
          },
          {
            url: "https://soundcloud.com/seventeen-scmusic/bout-you",
            answer: "'bout you' - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/seventeen-scmusic/shadow",
            answer: "Shadow - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/jaeguchi/seventeen-our-dawn-is-hotter-than-day",
            answer: "Our Dawn is Hotter Than Day - SEVENTEEN",
          ...
          {
            url: "https://soundcloud.com/seventeen-scmusic/ash",
            answer: "Ash - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/seventeen-scmusic/same-dream-same-mind-same",
            answer: "Same Dream, Same Mind, Same Night - SEVENTEEN",
          ...
          {
            url: "https://soundcloud.com/seventeen-scmusic/march",
            answer: "March - SEVENTEEN",
          },
          {
            url: "https://soundcloud.com/wonwoomingyu/bittersweet-feat-leehi",
            answer: "Bittersweet - WONWOO & MINGYU (feat. LeeHi)",
          },
          {
            url: "https://soundcloud.com/seventeen-scmusic/gam3-bo1",
            answer: "GAM3 BO1 - SEVENTEEN",
          ...
          {
            url: "https://soundcloud.com/pledis_seventeen/seventeen-mixtape-vol12-check-in-hiphop-team-scoups-wonwoo-mingyu-vernon",
            answer: "Check-In - HHU",
          },
          {
            url: "https://soundcloud.com/seventeen-scmusic/back-it-up",
          ...
          {
            url: "https://soundcloud.com/poethv/hai-cheng-seventeen-the8",
            answer: "Hai Cheng - THE8",
          },
          {
            url: "https://soundcloud.com/l2share106/seventeen-i-wish",
            answer: "I Wish - SEVENTEEN",
          ...
          {
            url: "https://soundcloud.com/pledis_seventeen/seventeen-mixtape-vol17-spider-hoshi",
            answer: "Spider - HOSHI",
          },
          {
            url: "https://soundcloud.com/l2share106/seventeen-fearless",
          ...
          {
            url: "https://soundcloud.com/runtomoon/silent-boarding-gate-seventeens-jun",
            answer: "Silent Boarding Gate - Wen Junhui",
          },
          {
            url: "https://soundcloud.com/zevi-hyun/seventeen-booseoksoon-just-do",
            answer: "Just Do It - BSS",
          ...
          {
            url: "https://soundcloud.com/blink8816/seventeen-cheers",
            answer: "CHEERS - SVT LEADERS",
          },
          {
            url: "https://soundcloud.com/sunnyb007/pretty-u-seventeen",
            answer: "Pretty U - SEVENTEEN",
      ...
      c() {
        (t = w("meta")),
          ...
          M(
            n,
            "href",
            "https://cdn.glitch.global/400621ec-e937-4461-b0a1-2a76ffbf03eb/sficon.png?v=1649469622472"
          ),
          M(s, "rel", "icon"),
          M(s, "type", "image/png"),
          M(s, "sizes", "32x32"),
          M(
            s,
            "href",
            "https://cdn.glitch.global/400621ec-e937-4461-b0a1-2a76ffbf03eb/sficon32.png?v=1649469622555"
          ),
          M(i, "rel", "icon"),
          M(i, "type", "image/png"),
          M(i, "sizes", "16x16"),
          M(
            i,
            "href",
            "https://cdn.glitch.global/400621ec-e937-4461-b0a1-2a76ffbf03eb/sficon16.png?v=1649469622472"
          ),
          M(o, "rel", "manifest"),
  ...
  function jn(e, t, n) {
    ...
    let dateDiff = x(Vt.startDate);
    for (
      let cycle = Math.floor(dateDiff / s.length) % 7, idx = cycle;
      idx < s.length;
      idx += 1 + ((cycle + idx) % 5)
    ) {
      let temp = s[idx - cycle];
      s[idx - cycle] = s[idx];
      s[idx] = temp;
    }
    let a = dateDiff % s.length,
      l = {
        url: s[a].url,
